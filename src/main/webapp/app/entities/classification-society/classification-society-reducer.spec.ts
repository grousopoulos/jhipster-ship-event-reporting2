...
import reducer, {
  ...
  reset,
  updateEntity,
} from './classification-society.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSIFICATIONSOCIETY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSIFICATIONSOCIETY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSIFICATIONSOCIETY actions', async () => {
      const arg = { id: 10320 };
    ...
    it('dispatches UPDATE_CLASSIFICATIONSOCIETY actions', async () => {
      const arg = { id: 10320 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSIFICATIONSOCIETY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSIFICATIONSOCIETY actions', async () => {
      const arg = 42666;
