...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONSUMPTIONLINE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONSUMPTIONLINE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONSUMPTIONLINE actions', async () => {
      const arg = { id: 20824 };
    ...
    it('dispatches UPDATE_CONSUMPTIONLINE actions', async () => {
      const arg = { id: 20824 };
    ...
    it('dispatches PARTIAL_UPDATE_CONSUMPTIONLINE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONSUMPTIONLINE actions', async () => {
      const arg = 42666;
