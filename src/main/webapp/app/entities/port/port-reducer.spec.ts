...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './port.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PORT actions', async () => {
      const arg = { id: 26881 };
    ...
    it('dispatches UPDATE_PORT actions', async () => {
      const arg = { id: 26881 };
    ...
    it('dispatches PARTIAL_UPDATE_PORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PORT actions', async () => {
      const arg = 42666;
