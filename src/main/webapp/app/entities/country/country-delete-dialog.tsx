...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterShipEventReporting2App.country.delete.question">
        <Translate contentKey="jhipsterShipEventReporting2App.country.delete.question" interpolate={{ id: countryEntity.id }}>
