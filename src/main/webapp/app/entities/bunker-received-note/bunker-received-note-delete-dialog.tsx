...
import { deleteEntity, getEntity } from './bunker-received-note.reducer';
...
export const BunkerReceivedNoteDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterShipEventReporting2App.bunkerReceivedNote.delete.question">
        <Translate
          contentKey="jhipsterShipEventReporting2App.bunkerReceivedNote.delete.question"
          interpolate={{ id: bunkerReceivedNoteEntity.id }}
        >
          Are you sure you want to delete this BunkerReceivedNote?
        </Translate>
      </ModalBody>
      <ModalFooter>
