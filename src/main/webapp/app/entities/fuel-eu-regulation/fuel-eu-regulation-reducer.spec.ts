...
import reducer, {
  ...
  reset,
  updateEntity,
} from './fuel-eu-regulation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUELEUREGULATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FUELEUREGULATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FUELEUREGULATION actions', async () => {
      const arg = { id: 2124 };
    ...
    it('dispatches UPDATE_FUELEUREGULATION actions', async () => {
      const arg = { id: 2124 };
    ...
    it('dispatches PARTIAL_UPDATE_FUELEUREGULATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FUELEUREGULATION actions', async () => {
      const arg = 42666;
