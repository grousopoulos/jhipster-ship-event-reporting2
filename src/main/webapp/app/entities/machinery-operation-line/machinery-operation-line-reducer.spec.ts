...
import reducer, {
  ...
  reset,
  updateEntity,
} from './machinery-operation-line.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MACHINERYOPERATIONLINE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MACHINERYOPERATIONLINE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MACHINERYOPERATIONLINE actions', async () => {
      const arg = { id: 16695 };
    ...
    it('dispatches UPDATE_MACHINERYOPERATIONLINE actions', async () => {
      const arg = { id: 16695 };
    ...
    it('dispatches PARTIAL_UPDATE_MACHINERYOPERATIONLINE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MACHINERYOPERATIONLINE actions', async () => {
      const arg = 42666;
