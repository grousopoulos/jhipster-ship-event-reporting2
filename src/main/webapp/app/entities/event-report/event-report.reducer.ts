...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IEventReport, thunkAPI) => {
    return axios.post<IEventReport>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IEventReport, thunkAPI) => {
    return axios.put<IEventReport>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IEventReport, thunkAPI) => {
    return axios.patch<IEventReport>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IEventReport>(requestUrl);
  },
  { serializeError: serializeAxiosError },
);
