...
public class ClassificationSociety implements Serializable {
    ...
    public ClassificationSociety id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ClassificationSociety code(String code) {
        this.setCode(code);
        return this;
    }
    ...
    public ClassificationSociety name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((ClassificationSociety) o).getId());
    }
