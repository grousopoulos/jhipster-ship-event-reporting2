...
public class CountryTestSamples {
    ...
    public static Country getCountrySample1() {
        return new Country().id(1L).code("code1").name("name1");
    }

    public static Country getCountrySample2() {
        return new Country().id(2L).code("code2").name("name2");
    }

    public static Country getCountryRandomSampleGenerator() {
        return new Country().id(longCount.incrementAndGet()).code(UUID.randomUUID().toString()).name(UUID.randomUUID().toString());
    }
}
